    ...
    if (response.length == 0) {
      ...
      $("[id^=row]").click(function () {
        ...
        if (confirm('해당 감독을 삭제하시겠습니까?')) {
          ...
          request2 = $.post('/DB_Project/delete_process/director_delete_process.php', {
            d_id: this.value,
          }, function (returnedData) {
...
<body>
  ...
  <nav class="navbar navbar-light bg-light static-top">
    <div class="container">
      ...
      <a href="/DB_Project/insert/director_insert.php">감독 추가</a>
    ...
    <div class="container">
      <div class="row">
        <div class="col-xl-9 mx-auto">
          <h1 class="mb-5">director 테이블 Query를 입력하세요</h1>
        </div>
        <div class="col-md-10 col-lg-8 col-xl-7 mx-auto">
          <form>
            <div class="form-row">
              <div class="col-12 col-md-9 mb-2 mb-md-0">
                <input type="text" id="search_value" class="form-control form-control-lg" placeholder="ex) select * from director">
              </div>
